"""Guess the Number by Jake Dobler, Jaecob.d1@gmail.com
...
print('Guess the Number, by Jake Dobler jaecob.d1@gmail.com')
print()
secretNumber = random.randint(1, 100) # Select a random number between 1 and 100
