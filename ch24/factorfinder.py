"""Factor Finder, by Jake Dobler jaecob.d1@gmail.com
Finds all the factors of a number
"""
import math, sys
print('''Factor Finder, by Jake Dobler jaecob.d1@gmail.com

A number's facrotrs are two numbers, that when multiplied with each 
other, product the number. For example, 2 x 13 = 26, so 2 and 13 are factors of 26. 1 x 26 = 26, so 1 and 26 are also factors of 26. We 
say that 26 only has four factors: 1, 2, 13, 26.
