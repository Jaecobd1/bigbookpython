"""Fibonacci Sequence, by Jake Dobler jaecob.d1@gmail.com
Calculates numbers of the Fibonacci sequence"""

import sys

print('''Fibonacci Sequence, by Jake Dobler jaecob.d1@gmail.com

The Fibonacci sequence begins with 0 and 1, and the next number is the sum of the previous two numbers. The sequence continues forever ''')
...
while True: # Main program loop
    ...
    while True:
        ...
        if fibNumberCalculated == nth:
            print()
            print()
            print('The #', fibNumberCalculated, ' Fibonacci ', 'number is ', nextNumber, sep='')
            break
