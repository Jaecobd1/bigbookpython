"""Clickbait Headline Generator, by Jake Dobler jaecob.d1@gmail.com
A clickbait headline generator for your solless content farm website.
"""
...
STATES = ['California', 'Texas', 'Florida', 'New York', 'Pennsylvania', 'Illinois','Ohio', 'Georgio', 'North Carolina', 'Michigan']
NOUNS = ['Athlete', 'Clown', 'Shovel', 'Paleo Diet', 'Doctor', 'Parent', 'Cat', 'Dog', 'Chicken', 'Robot', 'Video Game', 'Avocado', 'Plastic Straw', 'Serial Killer', 'Telephone Physhic']
PLACES = ['House', 'Attic', 'Bank Deposit Box', 'School', 'Basement', 'Workplace', 'Donut Shop', 'Apocalypse Bunker']
WHEN = ['Soon', 'This Year', 'Later Today', 'RIGHT NOW', 'Next Week']

def main():
    print('Clickbait Headline Generator')
    print('By Jake Dobler jaecob.d1@gmail.com')
    print()
...
def generateReasonsWhyHeadline():
    ...
    return '{} Reasons Why {} Are More Interesting Thank You Think (Number {} Will Suprise You!)'.format(number1, pluralNoun, number2)
