"""Calendar Maker, by Jake Dobler jaecob.d1@gmail.com"""
...
print('Calendar Maker, by Jake Dobler jaecob.d1@gmail.com')
...
def getCalendarFor(year, month):
    ...
    # Add the days of the week labels to the calendatr:
    ...
    while True: # Loop over each week in the month.
        ...
        if currentDate.month != month:
            break
    # Add the horizontal line at the very bottom of the valendar.
    calText += weekSeparator
    return calText
